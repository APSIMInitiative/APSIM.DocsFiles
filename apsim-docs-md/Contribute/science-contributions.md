...
* A science document may also be submitted by the model author (e.g. [see AgPasture science document](https://www.apsim.info/wp-content/uploads/2024/12/AgPastureScience.pdf)).
...
Sensibility tests will be provided to broaden the validation tests into other GxExM scenarios. This is particularly important when the validation is limited in its scope, in particular for GxExM situations that are thought to be important, but where there is no data. Sensibility tests need to be accompanied by [memo](/docs/usage/memo) text that describes what the sensibility plots show and why the results ‘make sense’.
...
![Copy model from replacements](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Development.Contribute.MoveModelToRelease.CopyModel.png?raw=true)
...
![Add model json as resource](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Development.Contribute.MoveModelToRelease.AddModelXmlAsResource.png?raw=true)
...
![Add to resX file](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Development.Contribute.MoveModelToRelease.AddToResXFile.png?raw=true)
