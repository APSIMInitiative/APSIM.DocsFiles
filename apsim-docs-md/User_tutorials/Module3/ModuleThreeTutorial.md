...
4. The simulation will use a different weather file. To do this:
	...
	![Change weather image](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img1.png)
5. In the `Clock` node, change the starting date to `1/1/1989` and the end date to `31/12/1989`
	![Clock variables](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img2.png)
6. Add the `Heavy Clay` soil from the `Training toolbox`
7. Delete `Soil` node
8. Set `Percent full` to 50 in the `Heavy Clay's` `Water` node.
![change water % full](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img3.png)
...
![NO3 amount](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img4.png)
![NH4 amount](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img5.png)
...
11. Copy a `Fertilise on fixed dates` management node to the field node. You can locate this by going to:
	...
	![Fertilise on fixed date node](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img6.png)
...
21. Rename `Series` to `NO3 total`
	...
	![NO3 total series variables](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img7.png)
22. Add another `Series` node to `Nitrogen`
23. Rename this `Series` to `NH4 total`
	- Variables for this `Series`
	![NH4 total series variables](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img8.png)
...
![Denitrification graph](https://raw.githubusercontent.com/APSIMInitiative/ApsimX/master/ApsimNG/Resources/DocsImages/moduleThreeImages/img9.png)
