...
![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather1.png?raw=true)  
...
![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather2.png?raw=true)  
...
![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather3.png?raw=true) 
...
![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather4.png?raw=true) 
...
![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather5.png?raw=true) 
...
![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather6.png?raw=true) 
...
![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather7.png?raw=true) 

The worksheet should now be complete.

![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather8.png?raw=true) 

Note: when using the excel file in APSIM, the sheet name must be specified:

![Usage](https://github.com/APSIMInitiative/ApsimX/blob/master/ApsimNG/Resources/DocsImages/Usage.ExcelWeather9.png?raw=true)